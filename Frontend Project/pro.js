...
function weatherFunctionality() {
    ...
    async function weatherAPICall() {
        var response = await fetch(`http://api.weatherapi.com/v1/current.json?key=2964a71190e044119ac144402262503&q=London&aqi=no
${apiKey}&q=${city}`)
...
function changeTheme() {
    ...
    theme.addEventListener('click', function () {
        ...
        if (flag == 0) {
            rootElement.style.setProperty('--pri', '#37331d')
            rootElement.style.setProperty('--sec', '#222831')
            rootElement.style.setProperty('--tri1', '#948979')
            rootElement.style.setProperty('--tri2', '#393E46')
            flag = 1
        } else if (flag == 1) {
            rootElement.style.setProperty('--pri', '#15112a')
            rootElement.style.setProperty('--sec', '#030303')
            rootElement.style.setProperty('--tri1', '#D4C9BE')
            rootElement.style.setProperty('--tri2', '#123458')
            flag = 2
        } else if (flag == 2) {
            rootElement.style.setProperty('--pri', '#0b2212')
